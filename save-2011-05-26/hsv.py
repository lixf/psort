...
# Sigmoid function.  Use to approximate mapping from spectral position
# to h value for hsv
# Function of general form ALPHA * (1/(a^{2x-1} + b)) - BETA
# Where ALPHA and BETA are normalization constants
def sigmoid(a, b, x):
    C1 = (a+b)/(1-a*a)
    C2 = a*b+1
    denom = a**(2*x-1) + b
    return C1*(C2/denom - a)
